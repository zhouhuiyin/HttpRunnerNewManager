...
def get_signature(id, key, body_json_str, o_headers={}):
    ...
    return headers['x-ycs-security-authorization']
...
#     id = "7c55cf2e-d4f0-41fe-909a-51a0db63109d"
#     key = "62dcbab3-4f8b-4680-8cb0-fb98092aec00"
#
#     base_url = r"https://api.yovole.com/v1"
#     base_url_east = r"https://cn-east-1.api.yovole.com/v1"
#     requests.packages.urllib3.disable_warnings()
#     print("<<---------------------------------------------------------------->>")
#
#     sub_url = r"/volume/list"
#     project_id = "8a83a0566afd3bbe016afdcd7537000b"
#     name_or_sn = "tttttt"
#     loop_status = LoopList(base_url_east, sub_url, project_id, name_or_sn, id, key)
#     loop_status.get_volume_status()
